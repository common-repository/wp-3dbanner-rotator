...
?>
<?php if(isset($grtr->messages['upload']) && is_array($grtr->messages['upload']) && count($grtr->messages['upload']) > 0): ?>
<div class="updated">
<p class="">
<?php foreach($grtr->messages['upload'] as $msg): ?>
	<span><?php print $msg; ?></span><br/>
<?php endforeach;?>
</p>
</div>
<?php endif; ?>
<script type="text/javascript">var rotator_current_album_id = <?php print $album['album_id']; ?>;</script>
<div class="dataTable_wrapper">
	<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
		...
		<?php rotator_get_table_actions(array('rotator_bulk_delete_images' => 'Delete', 
											'rotator_bulk_disable_images' => 'Disable', 
											'rotator_bulk_enable_images' => 'Enable')); ?>
	</div>
	...
	<tbody>
	<?php require_once RTR_PLUGIN_DIR . '/html/images_rows.php'; ?>
	</tbody>
	</table>
...
<div id="single_upload" class="tab_content">
	<form id="single_upload_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="rotator_single_image_upload" />
...
-->
	...
	var rotator_upload_dir = "<?php  /* add the replace "\\" to work on windows server */  print str_replace("\\","/",rotator_get_album_dir($album['album_id'])); ?>";
	var rotator_secw = "<?php 
	global $wpdb;
	$query = "SELECT txt FROM {$wpdb->prefix}rotator_misc WHERE ione=1 AND itwo=1 AND ithree=1 LIMIT 1";
